...
//     const targetPhone = whatsappNumber || process.env.NEXT_PUBLIC_WHATSAPP_NUMBER || "919006179569";
...
//     // 2. Auto Mark Selected Tickets as SOLD OUT in Store & Admin Panel
...
//     const ticketNumbersList = selectedTickets
//       .map((t) => t.number)
//       .join(", ");
...
//     // Track WhatsApp booking click as a Meta Lead event
//     if (
...
//         value: totalAmount,
//         currency: "INR",
//         content_name: "Kerala Mega Jackpot Booking",
//         num_items: count,
//       });
//     }

//     // Mark selected tickets as sold
//     selectedTicketIds.forEach((id) => {
//       toggleSoldStatus(id);
//     });
...
Please confirm my booking and provide payment details.`;
    ...
    // Meta Pixel: Track booking click as Subscribe event
    if (
      typeof window !== "undefined" &&
      typeof window.fbq === "function"
    ) {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 z-50 border-t border-slate-300 bg-white p-3.5 shadow-[0_-4px_16px_rgba(0,0,0,0.1)]">
      <div className="mx-auto flex max-w-md items-center justify-between gap-3">
        ...
        <div className="flex flex-col">
          ...
          <div className="flex items-baseline gap-1">
            <span className="font-serif text-2xl font-black text-[#064016]">
              ₹{totalAmount}
            </span>
        ...
        <button
          onClick={handleWhatsAppBooking}
          disabled={!isMinMet}
          className={`flex flex-1 items-center justify-center gap-2 rounded-xl px-4 py-3.5 text-sm font-extrabold shadow-md transition-all ${
            isMinMet
              ? "border-b-2 border-[#064016] bg-[#0b6623] text-white hover:bg-[#064016] active:scale-[0.98]"
